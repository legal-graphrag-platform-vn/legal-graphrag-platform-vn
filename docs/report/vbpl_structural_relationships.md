...
| `AMENDS` | `Document`, `Article`, `Clause`, `Point` | `Document`, `Article`, `Clause`, `Point` theo allowlist | Sửa đổi đơn vị cũ |
| `REPEALS` | `Document`, `Article`, `Clause`, `Point` | `Document`, `Article`, `Clause`, `Point` | Bãi bỏ văn bản/đơn vị |
