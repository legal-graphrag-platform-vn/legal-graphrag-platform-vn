...
export function DocumentDetailPanel({
   ...
   const {
      ...
      error: graphError,
   } = useDocumentGraph(doc.id, graphEnabled)
   ...
   return (
      <div className="flex flex-col h-full">
         ...
         <div className="px-5 py-4 border-b border-border bg-card shrink-0">
            ...
            {doc.title && <h2 className="text-base font-bold leading-snug mt-1">{doc.title}</h2>}
         ...
         <Tabs
            ...
            onValueChange={(v) => {
               if (v === 'graph') setGraphEnabled(true)
            }}
         >
                           ...
                           >
                              ...
                              {rel.affected_units.length > 0 && (
                                 <p className="text-[10px] text-muted-foreground mt-1.5">
                                    ...
                                    {rel.affected_units.length > 3 &&
                                       ` +${rel.affected_units.length - 3} khác`}
                                 </p>
                              )}
                           </button>
                        ))
