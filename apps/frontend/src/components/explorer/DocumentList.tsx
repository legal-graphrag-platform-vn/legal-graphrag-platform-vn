...
export function DocumentList({
   ...
   if (error) {
      return (
         <div className="flex-1 flex items-center justify-center p-4 text-xs text-destructive text-center">
            Không thể tải danh sách văn bản: {error}
         </div>
      )
   }
               ...
               >
                  ...
                  <div className="flex items-center gap-1.5 mt-1.5 flex-wrap">
                     {doc.doc_type && (
                        <Badge
                           variant="outline"
                           className="text-[10px] px-1.5 h-4 rounded-sm font-normal"
                        >
