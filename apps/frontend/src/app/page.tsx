...
export const metadata: Metadata = {
   ...
   description:
      'Giao diện nghiên cứu GraphRAG cho tra cứu Luật Doanh nghiệp 2020 với trích dẫn Điều, Khoản.',
}
...
const FEATURES = [
   ...
   },
   {
      ...
      desc: 'Câu trả lời pilot chỉ được hiển thị sau khi citation và grounding vượt kiểm tra bắt buộc.',
   ...
   {
      icon: Zap,
      title: 'Phản hồi có kiểm soát',
      desc: 'SSE chỉ truyền nội dung sau khi câu trả lời hoàn chỉnh đã vượt kiểm tra grounding.',
...
const STATS = [
   { value: '1', label: 'Văn bản trong pilot hiện tại' },
   { value: '8/8', label: 'Hard checks Answer QA' },
   { value: 'Article + Clause', label: 'Đơn vị vector retrieval' },
   { value: 'OPEN', label: 'Gate 7 mở rộng corpus' },
]

const PLANS = [
   {
      name: 'Pilot nghiên cứu',
      price: 'L59_2020',
      per: 'phạm vi hiện tại',
      features: [
         'Hybrid retrieval Article/Clause',
         'Graph expansion và temporal filter theo capability',
         'Câu trả lời có citation và deep link',
         'Không tuyên bố corpus-complete validity',
      ],
      cta: 'Mở giao diện pilot',
      href: '/chat',
      highlight: true,
   },
]
...
const USECASES = [
   {
      icon: Scale,
      title: 'Luật sư & Văn phòng luật',
      desc: 'Tra cứu án lệ, điều khoản liên quan, đối chiếu văn bản cũ-mới.',
   },
   {
      icon: BookOpen,
      title: 'Doanh nghiệp',
      desc: 'Tuân thủ pháp lý, kiểm tra hợp đồng, theo dõi thay đổi quy định.',
   },
   {
      icon: MessageSquare,
      title: 'Nghiên cứu & Học thuật',
      desc: 'Phân tích lịch sử lập pháp, so sánh văn bản đa thời kỳ.',
   },
]
      ...
      <div className="min-h-screen bg-background text-foreground antialiased">
                     ...
                     <Sheet>
                        ...
                        <SheetContent side="right">
                           ...
                           <nav className="flex flex-col gap-4 text-sm font-medium">
                              ...
                              <Link href="#usecases" className="hover:text-emerald-500">
                                 Ứng dụng
                              </Link>
         ...
         <section className="relative pt-32 pb-24 px-6 overflow-hidden">
            ...
            <div className="relative max-w-4xl mx-auto text-center">
               <Badge
                  variant="outline"
                  className="mb-6 text-xs px-3 py-1 border-emerald-500/30 text-emerald-600 dark:text-emerald-400 bg-emerald-500/5"
               >
               ...
               <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed">
                  Đặt câu hỏi pháp lý bằng tiếng Việt. Nhận câu trả lời với trích dẫn điều khoản có
                  kiểm chứng, đồ thị quan hệ văn bản, và lọc hiệu lực theo thời gian.
               </p>
               ...
               <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
                  <Link
                     ...
                     className={cn(
                        ...
                        'bg-emerald-600 hover:bg-emerald-700 text-white h-12 px-8 text-base',
                     )}
                  >
               ...
               <p className="mt-4 text-xs text-muted-foreground">
                  Bản nghiên cứu · Phạm vi dữ liệu và capability được công bố rõ
               </p>
            </div>
                        ...
                        <div className="space-y-2">
                           <p className="text-sm leading-relaxed">
                              ...
                              <span className="font-semibold text-emerald-600">
                                 Điều 111, Luật Doanh nghiệp 59/2020/QH14
                              </span>
                              , công ty cổ phần được thành lập khi đáp ứng các điều kiện sau:
                           </p>
                           <ul className="text-sm space-y-1 text-muted-foreground">
                              <li className="flex gap-2">
                                 <span className="text-emerald-500 mt-0.5">▸</span> Có tối thiểu{' '}
                                 <strong className="text-foreground">3 cổ đông sáng lập</strong>
                              </li>
                              <li className="flex gap-2">
                                 <span className="text-emerald-500 mt-0.5">▸</span> Vốn điều lệ được
                                 chia thành các{' '}
                                 <strong className="text-foreground">cổ phần bằng nhau</strong>
                              </li>
                              <li className="flex gap-2">
                                 <span className="text-emerald-500 mt-0.5">▸</span> Đăng ký kinh
                                 doanh tại{' '}
                           ...
                           <div className="flex gap-1.5 pt-1 flex-wrap">
                              {['Điều 111 LDN 2020', 'NĐ 01/2021/NĐ-CP', 'Điều 22'].map((s) => (
                                 <span
                                    key={s}
                                    className="text-[10px] px-2 py-0.5 rounded-full border border-emerald-500/30 bg-emerald-500/5 text-emerald-600 dark:text-emerald-400"
                                 >
                                    {s}
                                 </span>
                              ))}
            ...
            <div className="max-w-5xl mx-auto">
               ...
               <div className="grid md:grid-cols-3 gap-6">
                  {USECASES.map((u) => (
                     <div
                        key={u.title}
                        className="p-8 rounded-2xl border border-border bg-card text-center hover:shadow-lg transition-shadow"
                     >
                  ...
                  <div className="relative">
                     ...
                     <div className="flex flex-col sm:flex-row gap-3 justify-center">
                        <Link
                           ...
                           className={cn(
                              buttonVariants({ size: 'lg' }),
                              'bg-emerald-600 hover:bg-emerald-700 text-white h-12 px-8',
                           )}
                        >
