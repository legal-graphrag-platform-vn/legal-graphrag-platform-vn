...
> **Trạng thái**: Ontology/runtime contract v1.8.0 đã triển khai Part/Subsection và external structural references; curated artifact/database migration còn chờ; Gate 7/M3-B13 còn mở
...
|---|---|---|
| **[legal_ontology.md](./legal_ontology.md)** | **Ontology Contract FROZEN v1.8.0 — Source of Truth** | 🔴 Đọc trước |
...
|---|---|---|
| Ontology | `legal_ontology.md` v1.8.0 | Frozen; Part/Subsection corpus reparse/database migration required |
...
- [x] RC1 — Ontology: **FROZEN v1.8.0** — xem [legal_ontology.md](./legal_ontology.md)
