...
> **Trạng thái**: Pilot M3 evidence v1.5.1 đã sign-off nhưng stale sau ontology v1.7.0; Section/resolver code đã triển khai, curated artifact/database migration còn chờ; Gate 7/M3-B13 còn mở
...
|---|---|---|
| **[legal_ontology.md](./legal_ontology.md)** | **Ontology Contract FROZEN v1.7.0 — Source of Truth** | 🔴 Đọc trước |
...
## Current Execution Map (2026-07-31)

| Area | Current authority | Status |
|---|---|---|
| Ontology | `legal_ontology.md` v1.7.0 | Frozen; Section artifacts/database require migration |
...
| External structural references | `agent-plan-feats/17_external_structural_reference_materialization_plan.md` / ADR-24 | Implementation planned; corpus registry, reconciliation, and relation-only materialization pending |
...
- [x] RC1 — Ontology: **FROZEN v1.7.0** — xem [legal_ontology.md](./legal_ontology.md)
