...
> **Phiên bản**: 0.2 → thay bởi **[legal_ontology.md v1.5.0](../legal_ontology.md)**
> **Domain**: Pháp luật doanh nghiệp Việt Nam

> [!CAUTION]
> File này **đã lỗi thời**. Source of truth mới là **[legal_ontology.md](../legal_ontology.md)** (v1.5.0, frozen 2026-07-10).
